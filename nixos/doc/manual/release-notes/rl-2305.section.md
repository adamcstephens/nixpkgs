...
- [linux-enable-ir-emitter](https://github.com/EmixamPP/linux-enable-ir-emitter), a program that provides support for infrared cameras that are not directly enabled out of the box.
